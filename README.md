...
- **End of each wave:** a three-question check-in, then the original "Τέλος" screen with a way back to the overview and on to the next wave. The final quiz (ten questions drawn from all three waves) is offered once, at the end of the third wave.
